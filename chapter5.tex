...
{伸縮量制御による振幅調整}
        ...
        \subsection{近似モデルの励振データへのフィッティング}
          ...
          \begin{eqnarray}
            ...
            \omega=\frac{\pi}{t}
          \end{eqnarray}
          \fig{Adjust4-2.svg}{width=1\hsize}{Excitation experiment data and fitting data}
          ...
          半周期後に現在振幅から目標振幅に到達するために必要な最大長$l_{\mathrm{max}}$は振幅から求めることができる．
          \begin{eqnarray}
            \equlabel{l status}
        ...
        ここで，\equref{l status}において求められた最大長がロボットの伸縮可能最大長0.74 mを超えた場合は最大長0.74 mとし，
        伸縮可能最小長0.56 mを下回った場合は最大長0.56 mとし，
        次の半周期で目標振幅への到達を試みる．
        なお，最大長をロボットの伸縮可能最小長0.56 mとすることにより，励振を含まない単純な減衰となる．
        実験では，目標振幅を
        計測した角度と長さ指令値のデータを\figref{}に示す．
