\chapter[本研究におけるブラキエーション動作と実機構成]%
        ...
        \section{伸縮する単リンクブラキエーションロボットの実機構成}
          ...
          \figref{robot.eps}に全体図を示す．重さは3.0 kgであり，幅・奥行・高さは
          ...
          また，グリッパーは把持部品がサーボモジュール(双葉電子工業 RS406CB)で駆動する(\figref{gripper.eps})．
          ...
          \fig{gripper.eps}{width=0.5\hsize}{Gripper configuration}
